# 📦 数据集获取
- [esp32s3 WIFI CSI录制静态手势数据包含[fist,paper,scissor]](https://baidu.com)
- [esp32s3 WIFI CSI录制不同形状物体[奖杯，长方体盒子，圆台形盒子]](https://baidu.com)

# 📊 实验结果与曲线分析

我们将实验结果按照学习率和批大小的不同组合进行了分组对比。通过下表，可以直观地比较 CNN 与 MLP 模型在不同参数配置下的收敛表现。
